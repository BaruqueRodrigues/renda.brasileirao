...
#' @import httr
#' @examples
#' baixa_rendas_brasileirao_b(1:15)
baixa_rendas_brasileirao_b <- function(n_rodadas){
  ...
  executa_download <- function(n_rodadas){
    ...
    payload <- paste0("id_fase=3110&rodada=",
                      rodadas,
                      "&=&sort=")
    ...
    response <-
      VERB(
        ...
        add_headers(
          ...
          referer = 'https://www.srgoool.com.br/classificacao/Brasileirao/Serie-B/2022',
