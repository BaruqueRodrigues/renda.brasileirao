...
#' @import httr
#' @examples
#' baixa_rendas_brasileirao(1:15)
baixa_rendas_brasileirao <- function(n_rodadas){
  ...
  executa_download <- function(n_rodadas){
    ...
    payload <- paste0("id_fase=3109&rodada=",
                      rodadas,
                      "&=&sort=")
    ...
    response <-
      VERB(
        ...
        add_headers(
          ...
          referer = 'https://www.srgoool.com.br/classificacao/Brasileirao/Serie-A/2022',
