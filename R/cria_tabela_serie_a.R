...
#' Cria um datavis em formato tabular das medidas de variacao da variavel
#'
...
#' @examples
#' 
cria_tabela_serie_a<- function(df,
                               variavel, clubem,
  ...
  df_rendas  %>% 
    ...
    gt::tab_header(title = gtExtras::add_text_img(text = stringr::str_glue("{titulo} dos Clubes da Série A"),
                                    url = "https://brasileirao.cbf.com.br/img/logo-brasileirao-deitado.svg"
    ))
}
